"""
This module contains tests for the call_my_bluff.game module.
"""
import unittest
...
class TestGame(unittest.TestCase):
    def test_initialize_game_returns_state(self):
        ...
        state = cmb.game.initialize_game(2)
    ...
    def test_initialize_game_turn_order(self):
        ...
        state = cmb.game.initialize_game(4)
    ...
    def test_initialize_game_bet_index(self):
        ...
        state = cmb.game.initialize_game(4)
        self.assertTrue(state.bet.index == -1)
    ...
    def test_player_observation(self):
        ...
        self.assertIsInstance(observation, cmb.game.Observation)
